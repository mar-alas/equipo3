...
const NOMBRE_ESCENARIO = 'Escenario 101 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 101', () => {
  beforeEach(() => {
    loginPage.visit();
    //cy.screenshot(NOMBRE_ESCENARIO + '0_visit');
  });

  it('Login constraseña incorrecta, login credenciales correctas, creacion y validacion de un post, signout', () => {
    ...
    cy.useAleatorioCrearCorreo().then((formattedEmail) => {
      ...
      loginPage.error(/Your password is incorrect.\.|Your password is incorrect.(.*)|Too many attempts(.*)/)
