...
const NOMBRE_ESCENARIO = 'Escenario 99 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 99', () => {
  beforeEach(() => {
    loginPage.visit();
    //cy.screenshot(NOMBRE_ESCENARIO + '0_visit');
  });

  it('Login con exito, creacion y validacion de un post con contenido Toggle, signout', () => {
    ...
    cy.useAleatorioCrearPost().then((formattedPost) => {
      crearPost.crearPostContenidoToggle(formattedPost.title, formattedPost.body);
      cy.wait(TWO_SECONDS);
