//corrrer localmente: npx cypress run --spec "cypress/e2e/esc120.cy.js"
import loginPage from './authentication';
import crearPost from './post';
import useAprioriCrearPost from './posts_helper'

const NOMBRE_ESCENARIO = 'Escenario 120 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 120', () => {
  beforeEach(() => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido other url esperando 0 seg antes publicar', () => {
    ...
    cy.readFile('./cypress/data/other_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoOtherUrl(formattedPost.title, link_prueba, formattedPost.body,0);
