...
const NOMBRE_ESCENARIO = 'Escenario 054 -- Paso ';
const TAKE_SCREENSHOT = false;

describe("Login exitoso, crear pagina con titulo  y contenido de texto simple y luego editarla con datos de tarjeta de credito expuestos por una API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
  ...
  it("Login y creación de un page y luego edicion", () => {
    ...
    cy.getCreditCardAPI().then((data) => {
        // When I edit the page
        const content = data.credit_card;
