...
const NOMBRE_ESCENARIO = 'Escenario 057 -- Paso ';
const TAKE_SCREENSHOT = false;
const TWO_SECONDS = 2000;

describe("Login exitoso, crear pagina con titulo  y contenido de texto simple y luego editarla el titulo y contenido con Ids de seguridad social expuestos por una API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
  ...
  it("Login y creación de un page y luego edicion", () => {
    ...
    cy.getIdSeguridadSocialAPI().then((data) => {
        // When I edit the page
        const content = data.id_seguridad_social;
