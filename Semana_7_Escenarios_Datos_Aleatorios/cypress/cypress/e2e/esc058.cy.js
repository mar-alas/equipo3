...
const NOMBRE_ESCENARIO = 'Escenario 058 -- Paso ';
const TAKE_SCREENSHOT = false;
const TWO_SECONDS = 2000;

describe("Login exitoso, crear pagina con titulo  y contenido de texto simple y luego editar el titulo y contenido con direcciones MAC de computadores expuestos por una API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
  ...
  it("Login y creación de un page y luego edicion", () => {
    ...
    cy.getMacAddressAPI().then((data) => {
        // When I edit the page
        const content = data.mac;
