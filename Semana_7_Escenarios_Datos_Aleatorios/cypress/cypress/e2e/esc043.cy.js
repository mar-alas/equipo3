...
const NOMBRE_ESCENARIO = 'Escenario 043 -- Paso ';
const TAKE_SCREENSHOT = false;

describe("Login exitoso, crear pagina con titulo y contenido de TEXTO y luego editar el contenido con url de IMAGENES desde API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
