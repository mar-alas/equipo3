...
const NOMBRE_ESCENARIO = 'Escenario 052 -- Paso ';
const TAKE_SCREENSHOT = false;
const TWO_SECONDS = 2000;

describe("Login exitoso, crear pagina con titulo  y contenido de texto simple y luego editarla con titulo y contenido de sentencias SQL expuestos por una API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
