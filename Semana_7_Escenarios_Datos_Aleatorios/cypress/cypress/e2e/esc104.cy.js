...
const NOMBRE_ESCENARIO = 'Escenario 104 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 104', () => {
  beforeEach(() => {
    loginPage.visit();
  ...
  it('Login con exito, creacion y validacion de un post con bookmark, signout', () => {
    ...
    cy.usePoliDinamicoCrearPost().then((formattedPost) => {
      crearPost.crearPostContenidoYoutube(formattedPost.title, formattedPost.title, formattedPost.body,5);
      cy.wait(TWO_SECONDS);
