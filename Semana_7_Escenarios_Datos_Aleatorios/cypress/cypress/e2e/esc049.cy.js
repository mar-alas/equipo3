...
const NOMBRE_ESCENARIO = 'Escenario 049 -- Paso ';
const TAKE_SCREENSHOT = false;

describe("Login exitoso, crear pagina con titulo y contenido de texto simple y luego editar el contenido con claves MD5 desde API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
