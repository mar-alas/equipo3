//corrrer localmente: npx cypress run --spec "cypress/e2e/esc116.cy.js"
import loginPage from './authentication';
import crearPost from './post';
import useAprioriCrearPost from './posts_helper'

const NOMBRE_ESCENARIO = 'Escenario 116 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 116', () => {
  beforeEach(() => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido soundcloud sin esperar antes de publicar', () => {
    ...
    cy.readFile('./cypress/data/soundcloud_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoSoundCloud(formattedPost.title, link_prueba, formattedPost.body,0);
