//corrrer localmente: npx cypress run --spec "cypress/e2e/esc118.cy.js"
...
describe('Escenario 118', () => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido spotify esperando 0 seg antes publicar', () => {
    ...
    cy.readFile('./cypress/data/spotify_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoSpotify(formattedPost.title, link_prueba, formattedPost.body,0);
