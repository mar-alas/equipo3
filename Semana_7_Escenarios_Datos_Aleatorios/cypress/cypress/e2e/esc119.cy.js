...
const NOMBRE_ESCENARIO = 'Escenario 119 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 119', () => {
  beforeEach(() => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido other url esperando 5 seg antes publicar', () => {
    ...
    cy.readFile('./cypress/data/other_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoOtherUrl(formattedPost.title, link_prueba, formattedPost.body,5);
