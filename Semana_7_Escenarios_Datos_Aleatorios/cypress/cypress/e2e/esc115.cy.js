...
const NOMBRE_ESCENARIO = 'Escenario 115 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 115', () => {
  beforeEach(() => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido soundcloud', () => {
    ...
    cy.readFile('./cypress/data/soundcloud_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoSoundCloud(formattedPost.title, link_prueba, formattedPost.body,5);
