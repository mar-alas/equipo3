...
const NOMBRE_ESCENARIO = 'Escenario 050 -- Paso ';
const TAKE_SCREENSHOT = false;
const TWO_SECONDS = 2000;

describe("Login exitoso, crear pagina con titulo y contenido de texto simple y luego editar el contenido con coordenadas geograficas desde API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
  ...
  it("Login y creación de un page y luego edicion", () => {
    ...
    cy.getCoordenadasAPI().then((data) => {
        // When I edit the page
        const content = data.coordenadas;
