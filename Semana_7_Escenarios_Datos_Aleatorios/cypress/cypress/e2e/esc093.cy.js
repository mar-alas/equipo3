...
const NOMBRE_ESCENARIO = 'Escenario 93 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 93', () => {
  beforeEach(() => {
    loginPage.visit();
    //cy.screenshot(NOMBRE_ESCENARIO + '0_visit');
  });

  it('Login con exito, creacion y validacion de un post con markdown, signout', () => {
    ...
    cy.usePoliDinamicoCrearPost().then((formattedPost) => {
      crearPost.crearPostContenidoMarkdown(formattedPost.title, formattedPost.body);
      cy.wait(TWO_SECONDS);
