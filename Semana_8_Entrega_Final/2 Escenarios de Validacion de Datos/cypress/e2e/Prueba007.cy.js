//para correr esta prueba en cmd usar el comando: npx cypress run --spec "cypress/e2e/Prueba007.cy.js"
import loginPage from './authentication';
import crearPost from './post';
import useAprioriCrearPost from './posts_helper'

const NOMBRE_ESCENARIO = 'Prueba007 -- Paso ';
...
describe('Prueba007', () => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido youtube utilizando link spotify', () => {
    ...
    cy.readFile('./cypress/data/spotify_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.noExistePost(formattedPost.title);
