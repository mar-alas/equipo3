...
const NOMBRE_ESCENARIO = 'Escenario 107 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 107', () => {
  beforeEach(() => {
    loginPage.visit();
    //cy.screenshot(NOMBRE_ESCENARIO + '0_visit');
  });

  it('Login con exito, creacion y validacion de un post con codepen', () => {
    ...
    cy.usePoliDinamicoCrearPost().then((formattedPost) => {
      crearPost.crearPostContenidoCodePen(formattedPost.title, formattedPost.title, formattedPost.body,5);
      cy.wait(TWO_SECONDS);
