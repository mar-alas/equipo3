...
const NOMBRE_ESCENARIO = 'Escenario 055 -- Paso ';
const TAKE_SCREENSHOT = false;
const TWO_SECONDS = 2000;

describe("Login exitoso, crear pagina con titulo  y contenido de texto simple y luego editarla el titulo y contenido con direcciones de BitCoin expuestos por una API", () => {
  beforeEach(() => {
    loginPage.visit();
    if(TAKE_SCREENSHOT) {
  ...
  it("Login y creación de un page y luego edicion", () => {
    ...
    cy.getBitcoinAPI().then((data) => {
        // When I edit the page
        const content = data.bitcoin;
