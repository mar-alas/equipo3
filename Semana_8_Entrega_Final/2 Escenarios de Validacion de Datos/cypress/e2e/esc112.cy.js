//correr local: npx cypress run --spec "cypress/e2e/esc112.cy.js"
import loginPage from './authentication';
import crearPost from './post';
import useAprioriCrearPost from './posts_helper'

const NOMBRE_ESCENARIO = 'Escenario 112 -- Paso ';
const TWO_SECONDS = 2000;

describe('Escenario 112', () => {
  beforeEach(() => {
  ...
  it('Login con exito, creacion y validacion de un post con contenido X/Twitter sin esperar que el link cargue antes de publicar', () => {
    ...
    cy.readFile('./cypress/data/x_urls.json').then((Data) => {
      ...
      cy.useAprioriCrearPost().then((formattedPost) => {
        ...
        crearPost.crearPostContenidoXTwiter(formattedPost.title, link_prueba, formattedPost.body,0);
