...
const NOMBRE_ESCENARIO = 'Escenario 20 -- Paso ';
...
describe("Crear pagina Ghost", () => {
  ...
  it("Login y creación de 3 pages diferentes", () => {
    ...
    cy.screenshot(NOMBRE_ESCENARIO + '13_existenPagesRepetidas');

    crearPagina.existenPagesRepetidas("Mi pagina xyz3",1);
    cy.screenshot(NOMBRE_ESCENARIO + '14_existenPagesRepetidas');
